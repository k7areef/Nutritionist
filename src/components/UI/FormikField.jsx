...
function FormikField({ setFieldValue, label, typeField, icon, parentClassName, options, ...props }) {
    ...
    const sharedStyles = `w-full p-3 bg-green-90 border border-green-80 rounded-md transition duration-300 ease-in-out read-only:border-transparent not-read-only:focus:border-green-70`;
